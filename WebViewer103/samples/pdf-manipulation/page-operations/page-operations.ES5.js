!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      ...
      v(Vt, Dt),
        p(Vt, yt, Dt.values),
        v(Vt, { slice: Rt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Tt }),
        It(Vt, 'buffer', 'b'),
        It(Vt, 'byteOffset', 'o'),
        It(Vt, 'byteLength', 'l'),
        It(Vt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (a = w(r)) || 'SharedArrayBuffer' == a)) return xt in r ? jt(v, r) : At.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var y = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    function V(t, n, r, e, o, i) {
      ...
      for (var c = t[j]._b, a = u + t[A], f = e(+o), s = 0; s < n; s++) c[a + s] = f[i ? s : n - s - 1];
    }
    if (u.ABV) {
      if (
        !f(function() {
    ...
    var o = r(1),
      ...
      J = function(t, n, r) {
        return (
          ...
          (n = _(n, !0)),
          b(r),
          i(G, n) ? (r.enumerable ? (i(t, C) && t[C][n] && (t[C][n] = !1), (r = O(r, { enumerable: E(0, !1) }))) : (i(t, C) || L(t, C, E(1, {})), (t[C][n] = !0)), q(t, n, r)) : L(t, n, r)
        );
      },
      X = function(t, n) {
        b(t);
      ...
      tt = function(t) {
        for (var n, r = N(S(t)), e = [], o = 0; r.length > o; ) i(G, (n = r[o++])) || n == C || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === U, e = N(r ? V : S(t)), o = [], u = 0; e.length > u; ) !i(G, (n = e[u++])) || (r && !i(U, n)) || o.push(G[n]);
        return o;
      };
    z ||
      (a(
        (T = function() {
          ...
          var t = p(arguments.length > 0 ? arguments[0] : void 0),
            n = function n(r) {
              this === U && n.call(V, r), i(this, C) && i(this[C], t) && (this[C][t] = !1), q(this, t, E(1, r));
            };
    ...
    WebViewer({ path: '../../../lib', useDownloader: !1, initialDoc: '../../../samples/files/demo.pdf' }, document.getElementById('viewer')).then(function(t) {
      ...
      r.addEventListener('documentLoaded', function() {
        var t = r.getDocument(),
          ...
          a = document.getElementById('move-from'),
          f = document.getElementById('move-to'),
          s = document.getElementById('insert-at'),
          l = document.getElementById('extract-list'),
          h = document.getElementById('rotate'),
          p = document.getElementById('crop'),
          v = document.getElementById('delete'),
          y = document.getElementById('move'),
          d = document.getElementById('insert'),
          g = document.getElementById('extract'),
          m = document.getElementById('file-picker'),
          b = function(t) {
            var r, e;
            for (n.innerHTML = '', a.innerHTML = '', f.innerHTML = '', s.innerHTML = '', l.value = t > 1 ? '1-'.concat(t) : 1, r = 0; r < t; r++)
              ((e = document.createElement('option')).innerHTML = r + 1), n.appendChild(e), a.appendChild(e.cloneNode(!0)), f.appendChild(e.cloneNode(!0)), s.appendChild(e.cloneNode(!0));
            var o = e.cloneNode(!0);
            (o.innerHTML = r + 1), s.appendChild(o);
          };
        (h.onclick = function() {
          ...
          (v.onclick = function() {
            ...
            t.removePages([Number(n.value)]), b(r);
          }),
          (y.onclick = function() {
          ...
          (d.onclick = function() {
            var n = t.getPageInfo(1),
              ...
              e = n.height,
              o = t.getPageCount() + 1;
            t.insertBlankPages([Number(s.value)], r, e), b(o);
          }),
          (g.onclick = i(
            e().mark(function n() {
              var r, o, i, c, a, f, s;
              return e().wrap(function(n) {
                for (;;)
                  switch ((n.prev = n.next)) {
                    case 0:
                      if ((l.setCustomValidity(''), l.checkValidity())) {
                        n.next = 4;
                        break;
                      }
                      return l.reportValidity(), n.abrupt('return');
                    case 4:
                      return (
                        (r = []),
                        (o = t.getPageCount()),
                        l.value.split(',').forEach(function(t) {
                          var n = t.split('-'),
                            e = Number(n[0]),
                            i = Number(1 === n.length ? n[0] : n[1]);
                          i > o && (i = o);
                          for (var u = e; u <= i; u++) r.push(u);
                        }),
                        (i = u.getAnnotationsList().filter(function(t) {
                          return r.indexOf(t.PageNumber) > -1;
                        })),
                        (n.next = 10),
                        u.exportAnnotations({ annotationList: i })
                      );
                    case 10:
                      return (c = n.sent), (n.next = 13), t.extractPages(r, c);
                    case 13:
                      (a = n.sent), (f = new Uint8Array(a)), (s = new Blob([f], { type: 'application/pdf' })), saveAs(s, 'extracted.pdf');
                    case 17:
                    case 'end':
                      return n.stop();
                  }
          ...
          (l.oninvalid = function() {
            l.setCustomValidity('Should only contain valid page numbers, commas, or dashes ex 1,2,3-5');
          }),
          (m.onchange = function(n) {
            ...
            c(r, {}).then(function(n) {
              ...
              t.insertPages(n, r, t.getPageCount() + 1), b(o);
            });
          }),
          b(t.getPageCount());
      });
