!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        Nt = function() {
          return vt.apply(It ? ht.call(Pt(this)) : Pt(this), arguments);
        },
        kt = {
        ...
        Bt = function(t, n, r) {
          return !(Wt(t, (n = b(n, !0))) && S(r) && w(r, 'value')) || w(r, 'get') || w(r, 'set') || r.configurable || (w(r, 'writable') && !r.writable) || (w(r, 'enumerable') && !r.enumerable)
            ? G(t, n, r)
            : ((t[n] = r.value), t);
        };
      bt || ((B.f = Vt), (V.f = Bt)),
      ...
      v(Gt, Dt),
        p(Gt, dt, Dt.values),
        v(Gt, { slice: Rt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: Nt }),
        Mt(Gt, 'buffer', 'b'),
        Mt(Gt, 'byteOffset', 'o'),
        Mt(Gt, 'byteLength', 'l'),
        Mt(Gt, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof K || 'ArrayBuffer' == (a = x(r)) || 'SharedArrayBuffer' == a)) return wt in r ? jt(v, r) : Lt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var d = r.byteLength;
                  if (void 0 === o) {
            ...
            : (u(function() {
              ...
              $(m !== Function.prototype ? F(d).concat(F(m)) : F(d), function(t) {
                t in v || p(v, t, d[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, d, y, g) {
      ...
      var m,
        ...
        F = P || x(d),
        A = d ? (_ ? x('entries') : F) : void 0,
        j = ('Array' == n && O.entries) || P;
      if (
        (j && (w = s(j.call(new t()))) !== Object.prototype && w.next && (f(w, S, !0), e || 'function' == typeof w[l] || u(w, l, p)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? F : x('values'), keys: y ? F : x('keys'), entries: A }), g)) for (b in m) b in O || i(O, b, m[b]);
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      J = function(t, n) {
        b(t);
        for (var r, e = g((n = S(n))), o = 0, i = e.length; i > o; ) $(t, (r = e[o++]), n[r]);
        return t;
      },
      Z = function(t) {
      ...
      tt = function(t) {
        for (var n, r = I(S(t)), e = [], o = 0; r.length > o; ) i(B, (n = r[o++])) || n == C || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === U, e = I(r ? G : S(t)), o = [], u = 0; e.length > u; ) !i(B, (n = e[u++])) || (r && !i(U, n)) || o.push(B[n]);
        return o;
      };
    z ||
      (a(
        (N = function() {
          ...
          return u && q && Y(U, t, { configurable: !0, set: n }), K(t);
        }).prototype,
        'toString',
        function() {
          return this._k;
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var w, x = '', S = 0, _ = 0; _ < m.length; _++) {
            b = m[_];
            for (var E = String(b[0]), O = f(s(u(b.index), h.length), 0), P = [], F = 1; F < b.length; F++) P.push(void 0 === (w = b[F]) ? w : String(w));
            var A = b.groups;
            if (p) {
              var j = [E].concat(P, O, h);
              void 0 !== A && j.push(A);
              var M = String(n.apply(void 0, j));
            } else M = d(E, h, O, P, A, n);
  ...
  function(t, n, r) {
    for (
      ...
      var y,
        ...
        b = u[g],
        w = b && b.prototype;
      if (w && (w[s] || c(w, s, h), w[l] || c(w, l, g), (a[g] = h), m)) for (y in e) w[y] || i(w, y, e[y], !0);
    }
  },
  function(t, n, r) {
    (function(t) {
  ...
  function(t, n) {
    ...
    function u() {
      ...
      return (
        ...
        (F.prototype = {
          ...
          delegateYield: function(t, n, r) {
            return (this.delegate = { iterator: A(t), resultName: n, nextLoc: r }), 'next' === this.method && (this.arg = void 0), p;
          },
        }),
        t
      );
    ...
    WebViewer({ path: 'lib', css: 'styles.css', disabledElements: ['searchButton', 'pageNavOverlay', 'viewControlsButton', 'panToolButton'] }, f).then(
      (function() {
        var t = a(
          u().mark(function t(n) {
            var r, e, i, c, f, s, l;
                ...
                switch ((t.prev = t.next)) {
                  case 0:
                    return (
                      ...
                      (c = e.iframeWindow),
                      (f = e.Theme),
                      n.UI.setTheme(f.DARK),
                      (s = i.getAnnotationManager()),
                    ...
                    'https://pdftron.s3.amazonaws.com/downloads/pl/video/video.mp4',
                                      ...
                                      case 0:
                                        return (
                                          ...
                                          (r = i
                                            ...
                                            .getAllAnnotations()),
                                          (t.next = 4),
                                          s.exportAnnotations({ links: !1, widgets: !1, annotationList: r })
                                        );
                                      case 4:
                      ...
                      i.addEventListener('pageComplete', function(t, n) {
                        if (!l) {
                          ...
                          n.appendChild(h);
                          var p = h.querySelector('#play'),
                            v = h.querySelector('#pause'),
                            d = h.querySelector('#volume'),
                            y = h.querySelector('#muted'),
                            g = h.querySelector('#progress'),
                            m = h.querySelector('.markers'),
                            b = h.querySelector('#current-time'),
                            w = h.querySelector('#tooltip'),
                            x = f.getElement(),
                            S = function(t) {
                              for (; m.firstChild; ) m.removeChild(m.firstChild);
                              t.forEach(function(t) {
                                if (t.startTime <= f.duration) {
                                  var n = document.createElement('div');
                                  n.className = 'marker';
                                  var r = t.startTime / f.duration;
                                  n.onclick = function() {
                                    L(t.startTime);
                                  };
                                  var e = Math.floor(r * g.clientWidth) - 1;
                                  (n.style = 'left: '.concat(e, 'px')), m.appendChild(n);
                                }
                              });
                            };
                          s.addEventListener('annotationChanged', function() {
                            S(f.getAllAnnotations());
                          }),
                            S(f.getAllAnnotations()),
                            p.setAttribute('data-state', 'visible'),
                            v.setAttribute('data-state', 'hidden'),
                            x.addEventListener('play', function() {
                              p.setAttribute('data-state', 'hidden'), v.setAttribute('data-state', 'visible');
                            }),
                            x.addEventListener('pause', function() {
                              p.setAttribute('data-state', 'visible'), v.setAttribute('data-state', 'hidden');
                            }),
                            ...
                            x.addEventListener('volumechange', function(t) {
                              x.muted
                                ? (d.setAttribute('data-state', 'hidden'), y.setAttribute('data-state', 'visible'))
                                : (d.setAttribute('data-state', 'visible'), y.setAttribute('data-state', 'hidden'));
                            }),
                                      ...
                                      switch ((t.prev = t.next)) {
                                        case 0:
                                          return (
                                            ...
                                            (r = n.x),
                                            (e = n.width),
                                            (i = Array.from(E.getElementsByClassName('innerFrame')).filter(function(t) {
                          ...
                          E.addEventListener('scroll', _.debounce(P, 250));
                          var F,
                            A = 770 / i.getZoomLevel(),
                            j = f.getTotalFrames();
                          HyperList.create(E, {
                            height: 99,
                            width: A,
                                ...
                                u().mark(function t() {
                                  ...
                                  return u().wrap(function(t) {
                                    for (;;)
                                      switch ((t.prev = t.next)) {
                                        case 0:
                                          e.getVideo().updateAnnotationsToTime(x.currentTime),
                                            F && F.removeAttribute('data-state'),
                                            (n = f.getFrameFromTime(x.currentTime)),
                          ...
                          var M,
                            L = function(t) {
                              (x.currentTime = t), (g.value = x.currentTime), (b.innerHTML = ''.concat(f.getFormattedCurrentTime()));
                              var n = 100.5 * (f.getFrameFromTime(x.currentTime) - 1) - E.clientWidth / 2 + 46.25;
                              Math.abs(E.scrollLeft - n) < 800 ? E.scroll({ left: n, behavior: 'smooth' }) : (E.scrollLeft = n);
                            };
                          g.addEventListener('click', function(t) {
                            L(M);
                          }),
                            w.setAttribute('data-state', 'hidden'),
                            g.addEventListener('mousemove', function(t) {
                              var n = g.getBoundingClientRect().width,
                                r = ((t.offsetX * i.getZoom()) / n) * g.max;
                              (M = r), w.setAttribute('data-state', 'visible'), (w.style = 'left: '.concat(t.offsetX, 'px;')), (w.innerHTML = ''.concat(f.getFormattedTime(r)));
                            }),
                            g.addEventListener('mouseout', function(t) {
                              w.setAttribute('data-state', 'hidden');
                            }),
                            P();
                        }
