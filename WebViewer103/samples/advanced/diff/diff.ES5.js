!(function(t) {
  ...
  function(t, n, r) {
    ...
    if (r(8)) {
      var o = r(30),
        ...
        jt = function() {
          return vt.apply(Lt ? ht.call(Pt(this)) : Pt(this), arguments);
        },
        Rt = {
        ...
        kt = function(t, n) {
          return Tt(this, ht.call(Pt(this), t, n));
        },
        Ct = function(t) {
          Pt(this);
        ...
        Vt = function(t, n, r) {
          return !(Bt(t, (n = b(n, !0))) && S(r) && x(r, 'value')) || x(r, 'get') || x(r, 'set') || r.configurable || (x(r, 'writable') && !r.writable) || (x(r, 'enumerable') && !r.enumerable)
            ? U(t, n, r)
            : ((t[n] = r.value), t);
        };
      bt || ((V.f = Wt), (W.f = Vt)),
      ...
      v(Ut, Dt),
        p(Ut, dt, Dt.values),
        v(Ut, { slice: kt, set: Ct, constructor: function() {}, toString: pt, toLocaleString: jt }),
        Ft(Ut, 'buffer', 'b'),
        Ft(Ut, 'byteOffset', 'o'),
        Ft(Ut, 'byteLength', 'l'),
        Ft(Ut, 'length', 'e'),
          ...
          b
            ? ((v = r(function(t, r, e, o) {
                ...
                var i,
                  ...
                  h = 0;
                if (S(r)) {
                  if (!(r instanceof $ || 'ArrayBuffer' == (a = w(r)) || 'SharedArrayBuffer' == a)) return xt in r ? It(v, r) : Mt.call(v, r);
                  (i = r), (h = Ot(e, n));
                  var d = r.byteLength;
                  if (void 0 === o) {
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, d, y, g) {
      ...
      var m,
        ...
        A = P || w(d),
        T = d ? (_ ? w('entries') : A) : void 0,
        I = ('Array' == n && O.entries) || P;
      if (
        (I && (x = s(I.call(new t()))) !== Object.prototype && x.next && (f(x, S, !0), e || 'function' == typeof x[l] || u(x, l, p)),
        _ &&
          P &&
          'values' !== P.name &&
          ((E = !0),
        ...
        if (((m = { values: _ ? A : w('values'), keys: y ? A : w('keys'), entries: T }), g)) for (b in m) b in O || i(O, b, m[b]);
    ...
    var e,
      ...
      M = !!(function() {
        try {
          ...
          return (T || 'function' == typeof PromiseRejectionEvent) && t.then(I) instanceof n && 0 !== P.indexOf('6.6') && -1 === w.indexOf('Chrome/66');
        } catch (t) {}
      })(),
      N = function(t) {
        var n;
  ...
  function(t, n, r) {
    ...
    var o = r(1),
      ...
      Q = function(t, n) {
        if (((t = S(t)), (n = _(n, !0)), t !== G || !i(V, n) || i(U, n))) {
          var r = M(t, n);
          return !r || !i(V, n) || (i(t, C) && t[C][n]) || (r.enumerable = !0), r;
        }
      },
      tt = function(t) {
        for (var n, r = L(S(t)), e = [], o = 0; r.length > o; ) i(V, (n = r[o++])) || n == C || n == f || e.push(n);
        return e;
      },
      nt = function(t) {
        for (var n, r = t === G, e = L(r ? U : S(t)), o = [], u = 0; e.length > u; ) !i(V, (n = e[u++])) || (r && !i(G, n)) || o.push(V[n]);
        return o;
      };
    Y ||
      (a(
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var x, w = '', S = 0, _ = 0; _ < m.length; _++) {
            ...
            } else F = d(E, h, O, P, T, n);
            O >= S && ((w += h.slice(S, O) + F), (S = O + E.length));
          }
          return w + h.slice(S);
        },
      ];
        ...
        return (
          ...
          (P.prototype = {
            ...
            delegateYield: function(t, n, r) {
              return (this.delegate = { iterator: A(t), resultName: n, nextLoc: r }), 'next' === this.method && (this.arg = void 0), h;
            },
          }),
          t
        );
  ...
  function(t, n) {
    function r() {
      ...
      function l(t, n, r, e) {
        var i = n && n.prototype instanceof v ? n : v,
          u = Object.create(i.prototype),
          c = new A(e || []);
        return o(u, '_invoke', { value: _(t, r, c) }), u;
      }
      function h(t, n, r) {
        try {
          return { type: 'normal', arg: t.call(n, r) };
      ...
      return (
        ...
        (t.mark = function(t) {
          return Object.setPrototypeOf ? Object.setPrototypeOf(t, y) : ((t.__proto__ = y), s(t, f, 'GeneratorFunction')), (t.prototype = Object.create(x)), t;
        }),
        (t.awrap = function(t) {
          return { __await: t };
        }),
    ...
    !(function(t) {
            ...
            return r().wrap(function(t) {
              for (;;)
                switch ((t.prev = t.next)) {
                  case 0:
                    return (t.next = 2), m(n).loadDocument(e);
                  case 2:
                  case 'end':
                    return t.stop();
                }
      ...
      function O(t, n, r, e, o, i) {
        g(d).updatePageWithAlignment(r, e, t, n, i, o);
      }
      function P(r) {
        return new Promise(function(o) {
          var i = document.getElementById(r.panel);
          window.WebViewer.WebComponent(
            {
              path: '../../../lib',
              css: './nudge-tool.css',
              workerTransportPromise: w(r.pdf),
              initialDoc: r.pdf || null,
            ...
            c.UI.syncNamespaces({ PDFNet: n.PDFNet }), samplesSetup(c);
            var a = c.UI,
              f = c.Core.documentViewer,
              s = a.Feature,
              v = a.LayoutMode,
              b = a.FitMode;
            a.disableFeatures([s.Annotations]),
              a.setToolMode('AnnotationEdit'),
              f.addEventListener('documentLoaded', function() {
                a.setLayoutMode(v.Single),
                  a.setFitMode(b.FitWidth),
                  r.panel !== d &&
                    f.getDocument().addEventListener('layersUpdated', function() {
                      var t = m(d);
                      g(d) && (t.refreshAll(), t.updateView());
                    });
                var n = document.getElementById('wc-'.concat(r.panel)),
                  o = n ? n.shadowRoot.querySelector('.DocumentContainer') : i.querySelector('iframe').contentDocument.querySelector('.DocumentContainer');
                (o.onscroll = function() {
                  var n, r;
                  t.DiffAlignmentTool.isInAlignmentMode() ||
                    ...
                    h.forEach(function(t) {
                      var e = p[t.panel].documentContainer;
                      e && (e.scrollLeft !== n && (e.scrollLeft = n), e.scrollTop !== r && (e.scrollTop = r));
                    }),
                    clearTimeout(e),
                  ...
                  f.addEventListener('zoomUpdated', function(n) {
                    l ||
                      ((l = o),
                      clearTimeout(e),
                      (e = setTimeout(function() {
                  ...
                  f.addEventListener('rotationUpdated', function(t) {
                    !(function(t) {
                      h.forEach(function(n) {
                        var r = m(n.panel);
                  ...
                  f.addEventListener('pageNumberUpdated', function(n) {
                    t.DiffAlignmentTool.isInAlignmentMode()
                      ? r.panel !== y &&
                        h.forEach(function(t) {
                          m(t.panel).getCurrentPage() !== n && t.panel !== y && m(t.panel).setCurrentPage(n);
                        })
                      : E(n);
                  }),
                  (p[r.panel].documentContainer = o);
              }),
              h.push(r),
              (p[r.panel] = { instance: c }),
              o();
          });
        });
      }
      ...
      function T() {
        return (T = o(
          r().mark(function n(e, o) {
            var i, c, a;
            return r().wrap(function(n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    return (u = !0), (n.next = 3), Promise.all([S(v, e), S(y, o)]);
                  case 3:
                    return (
                      ...
                      (i = p[v].instance.Core.documentViewer.getDocument()),
                      (c = p[y].instance.Core.documentViewer.getDocument()),
                      (a = [
                        { document: i, Core: p[v].instance.Core },
                        { document: c, Core: p[y].instance.Core },
                      ]),
                      (n.next = 9),
                      t.CompareDocumentManager.initialize(p[d].instance.Core, a, {
      ...
      (f = [{ panel: v }, { panel: d }, { panel: y }]),
          ...
          r().mark(function n() {
            return r().wrap(function(n) {
              for (;;)
                switch ((n.prev = n.next)) {
                  case 0:
                    return (n.next = 2), A(''.concat(window.location.href, '../../../samples/files/test_doc_1.pdf'), ''.concat(window.location.href, '../../../samples/files/test_doc_2.pdf'));
                  case 2:
                    t.NudgeTool.initializeNudgeTool(function(t) {
                      x(t);
                    }),
                      (document.getElementById('enable-snap-mode').disabled = !p[v].instance.Core.isFullPDFEnabled() && !p[y].instance.Core.isFullPDFEnabled());
                  case 4:
                  case 'end':
                    return n.stop();
                }
        ...
        Promise.all(f.map(P)).then(function() {
          return p[d].instance.UI.disableElements(['leftPanelButton', 'searchButton', 'searchPanel', 'searchOverlay']), s();
        }),
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        ...
                        (o = e.options[e.selectedIndex].value),
                        (i = document.getElementById('select2')),
                        (u = i.options[i.selectedIndex].value),
                        (t.next = 7),
                        A(window.location.href + o, window.location.href + u)
                      );
                    case 7:
                    case 'end':
                      return t.stop();
            ...
            r().mark(function t(n) {
              ...
              return r().wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return n.preventDefault(), (e = document.getElementById('url').value), (o = document.getElementById('url2').value), (t.next = 5), A(e, o);
                    case 5:
                    case 'end':
                      return t.stop();
                  }
            ...
            r().mark(function t(n) {
              ...
              return r().wrap(function(t) {
                for (;;)
                  switch ((t.prev = t.next)) {
                    case 0:
                      return n.preventDefault(), (e = document.forms['file-picker-form'][0].files[0]), (o = document.forms['file-picker-form'][1].files[0]), (t.next = 5), A(e, o);
                    case 5:
                    case 'end':
                      return t.stop();
                  }
