        ...
        Rt = {
          ...
          subarray: function(t, n) {
            var r = At(this),
              e = r.length,
              o = b(t, e);
            return new (j(r, r[bt]))(r.buffer, r.byteOffset + o * r.BYTES_PER_ELEMENT, d((void 0 === n ? e : b(n, e)) - o));
          },
        },
        Ct = function(t, n) {
        ...
        (t.exports = function(t, n, r, e) {
          ...
          m
            ...
            : (u(function() {
              ...
              Z(b !== Function.prototype ? I(y).concat(I(b)) : I(y), function(t) {
                t in v || p(v, t, y[t]);
              }),
              (v.prototype = _),
              o || (_.constructor = v));
  ...
  function(t, n, r) {
    ...
    t.exports = function(t, n, r, v, y, d, g) {
      ...
      if (
        ...
        if (((b = { values: _ ? I : x('values'), keys: d ? I : x('keys'), entries: N }), g)) for (m in b) m in E || i(E, m, b[m]);
      ...
      return [
        ...
        function(t, n) {
          ...
          for (var S, x = '', w = 0, _ = 0; _ < b.length; _++) {
            m = b[_];
            for (var O = String(m[0]), E = a(s(u(m.index), h.length), 0), A = [], I = 1; I < m.length; I++) A.push(void 0 === (S = m[I]) ? S : String(S));
            var N = m.groups;
            if (p) {
    ...
    !(function(t) {
      ...
      t.NudgeTool = {
        initializeNudgeTool: function(t) {
          ...
          var u = document.getElementById('resultPanel'),
            c = u.getElementsByTagName('apryse-webviewer')[0],
            f = c && c.shadowRoot ? c.shadowRoot : u.querySelector('iframe').contentDocument.querySelector('body');
