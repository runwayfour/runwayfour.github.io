                      ...
                      switch ((n.prev = n.next)) {
                        case 0:
                          if (
                            ...
                            (i = o.filesToCompare),
                            (a = o.options),
                            (this.filesToCompare = i),
                            (this.options = a),
                            (this.sourcePageIndexToAlignForTarget = {}),
                            (this.dummyAnnotManagers = []),
                            (c = this.filesToCompare[t.BASE_DOCUMENT_INDEX].document),
                          ...
                          return (
                            (p = c.getDocumentCompletePromise()),
                            (v = f.getDocumentCompletePromise()),
                            (g =
                              null == p
                                ? void 0
                                : p.then(function() {
                        ...
                        case 17:
                          return (n.t1 = n.sent), (n.next = 20), y;
                        case 20:
                          for (n.t2 = n.sent, u = n.t0.max.call(n.t0, n.t1, n.t2), d = 1; d <= u; d++)
                            (m = c.getPageInfo(d)),
                              (b = f.getPageInfo(d)),
                              (x = void 0),
                              (w = void 0),
                              this.alignmentPageStates.setTransformationStateForPageNumber(d, t.DEFAULT_TRANSFORM_STATE),
                              this.nudgePageStates.setTransformationStateForPageNumber(d, t.DEFAULT_NUDGE_STATE),
                              m && b
                                ? ((S = Math.max(m.width, b.width)), (_ = Math.max(m.height, b.height)), (w = c.getPages()[d - 1]), ((x = l(d, w)).width = S), (x.height = _))
                                : m
                                ? ((w = c.getPages()[d - 1]), (x = l(d, w)))
                                : ((w = f.getPages()[d - 1]), (x = l(d, w))),
                              this.addPage(x);
                                      ...
                                      return s().wrap(function(t) {
                                        for (;;)
                                          switch ((t.prev = t.next)) {
                                            case 0:
                                              return (
                                                (e = new P.filesToCompare[r].Core.DocumentViewer()).setViewerElement(document.createElement('div')),
                              ...
                              return (
                                ...
                                v
                                  ? ((h = f.width),
                                    ...
                                    (g = window.Core.getPageMatrix(i, (c || 0) % 4, y, null, !0, window.Core.getCanvasMultiplier())),
